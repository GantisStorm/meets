...
- [ ] I created this contribution or otherwise have the right to submit it
      under Meets's
      [MIT License](https://github.com/GantisStorm/meets/blob/main/LICENSE).
...
<!-- List each source and license/terms, or write "None". -->

### AI assistance

<!-- Name the tool/service and describe its material use, or write "None". -->
