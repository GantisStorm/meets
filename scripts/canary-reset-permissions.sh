...
#   ./scripts/canary-reset-permissions.sh --bundle-id com.meets.canary
#   ./scripts/canary-reset-permissions.sh --dry-run

BUNDLE_ID="${MEETS_CANARY_BUNDLE_ID:-com.meets.canary}"
APP_PROCESS_NAME="${MEETS_CANARY_PROCESS_NAME:-MeetsCanary}"
DRY_RUN=0
FORCE=0
