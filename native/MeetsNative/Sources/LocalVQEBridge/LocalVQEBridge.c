...
static void context_error(MeetsLocalVQEContext *context, const char *message) {
    if (context != NULL) {
...
MeetsLocalVQEContext *meets_localvqe_create(
    ...
    MeetsLocalVQEContext *context = (MeetsLocalVQEContext *)calloc(1, sizeof(MeetsLocalVQEContext));
    if (context == NULL) {
...
int meets_localvqe_process_frame_f32(
    ...
    int hop = meets_localvqe_hop_length(context);
    if (hop_samples != hop) {
