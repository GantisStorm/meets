...
/// Portable import/export support for Meets's personal dictionary.
///
...
/// dictionary usable from both the app and `meets-cli` without duplicating
/// format handling.
public enum CustomWordDictionaryCodec {
    ...
    public enum Error: Swift.Error, Equatable, LocalizedError {
        ...
        public var errorDescription: String? {
            "The file is not a valid Meets dictionary."
        }
    }
