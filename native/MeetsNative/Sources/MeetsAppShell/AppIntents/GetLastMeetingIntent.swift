...
struct GetLastMeetingIntent: AppIntent {
    ...
    static var description = IntentDescription("Returns the formatted notes from your most recent Meets meeting.")

    func perform() async throws -> some IntentResult & ReturnsValue<String> {
        let store = try MeetsShortcutsStore.open()
        ...
        throw MeetsShortcutsError.noMeetings
    }
}
