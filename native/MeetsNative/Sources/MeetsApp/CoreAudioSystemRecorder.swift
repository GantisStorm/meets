...
final class CoreAudioSystemRecorder: SystemAudioCapturing, SystemAudioDiagnosticsProviding {
    ...
    private let deviceIOQueue = DispatchQueue(label: "com.meets.system-audio-tap.io", qos: .userInitiated)
    private let processingQueue = DispatchQueue(label: "com.meets.system-audio-tap")
    ...
    private let routeSignalQueue = DispatchQueue(label: "com.meets.system-audio-route-signal")
    ...
    private func startCapture() throws {
        ...
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("meets-system-audio", isDirectory: true)
    ...
    private func createTapAndAggregateDevice() throws {
        ...
        // output mixed to stereo, excluding Meets itself. The previous
        ...
        // crashed session still holds the stable UID (or another Meets
        ...
        var aggUID = "com.meets.system-audio-tap"
        ...
        if status != noErr || aggregateDeviceID == kAudioObjectUnknown {
            ...
            aggUID = "com.meets.system-audio-tap-fallback"
    ...
    static func makeAggregateDeviceDescription(tapUID: String, aggregateUID: String) -> NSDictionary {
        [
            kAudioAggregateDeviceNameKey: "Meets System Audio",
    ...
    static func cleanupStaleDevices() {
        ...
        for deviceID in devices {
            ...
            if (name.takeRetainedValue() as String) == "Meets System Audio" {
