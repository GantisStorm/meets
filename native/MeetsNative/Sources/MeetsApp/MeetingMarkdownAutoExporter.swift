...
final class MeetingMarkdownAutoExporter: MeetingMarkdownAutoExporting {
    private static let logger = Logger(subsystem: "com.meets.native", category: "MarkdownAutoExport")

    private let supportDirectory: URL
    private let fileManager: FileManager
    private let logQueue = DispatchQueue(label: "com.meets.native.markdown-auto-export-log")
