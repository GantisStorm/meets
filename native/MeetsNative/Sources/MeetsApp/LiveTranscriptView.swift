...
struct LiveTranscriptBubble: View {
        ...
        HStack(alignment: .bottom, spacing: 6) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                ForEach(Array(lines.enumerated()), id: \.offset) { _, line in
                    Text(line)
                        .font(.system(size: 13))
                        .italic(isPartial)
                        .foregroundStyle(isPartial ? MeetsTheme.textSecondary : MeetsTheme.textPrimary)
            ...
            .overlay {
                RoundedRectangle(cornerRadius: MeetsTheme.cornerSmall)
                    .strokeBorder(
                        isPartial ? MeetsTheme.surfaceBorder : committedBorder,
    ...
    private var copyButton: some View {
        Button(action: copyMessage) {
            Image(systemName: didCopy ? "checkmark" : "doc.on.doc")
                ...
                .foregroundStyle(didCopy ? MeetsTheme.success : MeetsTheme.textSecondary)
    ...
    private var bubbleBackground: Color {
        if isPartial {
            return isUser ? MeetsTheme.accent.opacity(0.06) : MeetsTheme.surfacePrimary.opacity(0.5)
        }
        return isUser ? MeetsTheme.accent.opacity(0.15) : MeetsTheme.surfacePrimary
    }

    private var committedBorder: Color {
        isUser ? MeetsTheme.accent.opacity(0.2) : MeetsTheme.surfaceBorder
    }
}
    ...
    var body: some View {
        ZStack(alignment: .topTrailing) {
            ScrollViewReader { proxy in
                ScrollView {
                    LiveTranscriptFeedView(
                        ...
                        horizontalPadding: MeetsTheme.spacing16,
                        topPadding: 44,
                        bottomPadding: MeetsTheme.spacing8
                    )
            ...
            Button(action: copyTranscript) {
                ...
                .foregroundStyle(didCopy ? MeetsTheme.success : MeetsTheme.textPrimary)
