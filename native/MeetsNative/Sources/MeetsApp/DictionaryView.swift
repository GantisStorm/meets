...
private enum DictionaryRowMetrics {
    ...
    static let actionsWidth: CGFloat = actionButtonSize * 2 + MeetsTheme.spacing8
}
...
struct DictionaryView: View {
    ...
    private func exportDictionary() {
        ...
        panel.prompt = "Export"
        panel.nameFieldStringValue = "meets-dictionary.json"
        panel.allowedContentTypes = [.json]
...
private struct DictionaryWordEditorRow: View {
    ...
    init(word: CustomWord, controller: MeetsController) {
        self.word = word
    ...
    var body: some View {
        HStack(spacing: MeetsTheme.spacing8) {
            ...
            DictionaryIconButton(
                systemName: "checkmark",
                label: "Save word",
                tint: hasChanges && !trimmedWord.isEmpty ? MeetsTheme.accent : MeetsTheme.textTertiary,
    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            ZStack(alignment: .leading) {
                Capsule()
                    .fill(MeetsTheme.surfacePrimary)
