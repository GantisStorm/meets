...
enum MeetsTelemetryChannel: String, CaseIterable, Sendable {
    case production
    case preprod
    case dev
    case canary
...
struct TelemetryRuntimeConfiguration: Equatable, Sendable {
    static let appIDInfoKey = "MeetsTelemetryDeckAppID"
    static let channelInfoKey = "MeetsTelemetryChannel"
    static let disabledSDKAppID = "00000000-0000-0000-0000-000000000000"

    let appID: String
    let channel: MeetsTelemetryChannel
    let bundleID: String
    let isEnabled: Bool
    ...
    static func resolve(
        ...
        let channel = MeetsTelemetryChannel(rawValue: rawChannel) ?? .unconfigured
