...
let package = Package(
    ...
    products: [
        .library(name: "MeetsCore", targets: ["MeetsCore"]),
        .library(name: "MeetsAppCore", targets: ["MeetsApp"]),
        .executable(name: "MeetsApp", targets: ["MeetsAppShell"]),
        .executable(name: "meets-cli", targets: ["MeetsCLI"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        // the existing MeetsApp module so a genuine Xcode Application
        ...
        .testTarget(
            name: "MeetsTests",
            dependencies: ["MeetsApp", "MeetsCore", "MeetsCLI", "AudioGraphExceptionBridge", "LocalVQEBridge"],
            path: "Tests/MeetsTests",
            linkerSettings: [
                .linkedLibrary("sqlite3"),
            ]
        ),
