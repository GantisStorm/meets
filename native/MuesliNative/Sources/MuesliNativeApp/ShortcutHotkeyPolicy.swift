...
struct ShortcutHotkeyPolicy {
    ...
    static let commonGlobalShortcutWarning = "This shortcut is commonly used by other apps. Meets listens globally, so choose a less common combination if it conflicts with your workflow."
    ...
    static func validateMeetingRecordingHotkey(
        ...
        .updated(notice: commonGlobalShortcutWarning(for: hotkey))
    }
